...
@section('style')
 <link rel="alternate" type="application/rss+xml"
    ...
    <link rel='stylesheet' id='icofont-css' href='front_end/wp-content/themes/backhoe/css/icofont.min.css'
        type='text/css' media='all' />
    <link rel='stylesheet' id='swiper-bundle-css' href='front_end/wp-content/themes/backhoe/css/swiper-bundle.min.css'
        type='text/css' media='all' />
    ...
    <link rel='stylesheet' id='js_composer_front-css'
        href='front_end/wp-content/plugins/js_composer/assets/css/js_composer.min.css' type='text/css' media='all' />
    <script type="text/javascript" src="front_end/wp-includes/js/jquery/jquery.min.js" id="jquery-core-js"></script>
    <script type="text/javascript"
        id="wd_main_js_functions-js-extra">var devia = { "ajax_url": "https:\/\/themes.webdevia.com\/backhoe-heavy-construction-equipment-rentals-machinery-wordpress-theme\/wp-admin\/admin-ajax.php", "home_url": "https:\/\/themes.webdevia.com\/backhoe-heavy-construction-equipment-rentals-machinery-wordpress-theme", "date_format": "d\/m\/Y" };</script>
    <script type="module" src="front_end/wp-content/plugins/wd-main-plugin/js/PhotoSwipeLightbox.js"></script>
    <script type="text/javascript"
        id="wc-add-to-cart-js-extra">var wc_add_to_cart_params = { "ajax_url": "\/backhoe-heavy-construction-equipment-rentals-machinery-wordpress-theme\/wp-admin\/admin-ajax.php", "wc_ajax_url": "\/backhoe-heavy-construction-equipment-rentals-machinery-wordpress-theme\/?wc-ajax=%%endpoint%%", "i18n_view_cart": "View cart", "cart_url": "https:\/\/themes.webdevia.com\/backhoe-heavy-construction-equipment-rentals-machinery-wordpress-theme\/cart\/", "is_cart": "", "cart_redirect_after_add": "no" };</script>
    <script type="text/javascript"
        id="woocommerce-js-extra">var woocommerce_params = { "ajax_url": "\/backhoe-heavy-construction-equipment-rentals-machinery-wordpress-theme\/wp-admin\/admin-ajax.php", "wc_ajax_url": "\/backhoe-heavy-construction-equipment-rentals-machinery-wordpress-theme\/?wc-ajax=%%endpoint%%", "i18n_password_show": "Show password", "i18n_password_hide": "Hide password" };</script>
    <script type="text/javascript"
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAK-lm5gdnsKARlSb10nkRfKoGCycwH49Y&amp;ver=4.4.2"
        id="googleapis-js"></script>
    <script type="text/javascript"
        id="simple-auction-countdown-language-js-extra">var countdown_language_data = { "labels": { "Years": "Years", "Months": "Months", "Weeks": "Weeks", "Days": "Days", "Hours": "Hours", "Minutes": "Minutes", "Seconds": "Seconds" }, "labels1": { "Year": "Year", "Month": "Month", "Week": "Week", "Day": "Day", "Hour": "Hour", "Minute": "Minute", "Second": "Second" }, "compactLabels": { "y": "y", "m": "m", "w": "w", "d": "d" } };</script>
    <script type="text/javascript"
        id="simple-auction-frontend-js-extra">var data = { "finished": "Auction has finished!", "checking": "Patience please, we are checking if auction is finished!", "gtm_offset": "0", "started": "Auction has started! Please refresh your page.", "no_need": "No need to bid. Your bid is winning! ", "compact_counter": "no", "outbid_message": "\n<ul class=\"woocommerce-error\" role=\"alert\">\n\t\t\t<li>\n\t\t\tYou've been outbid!\t\t<\/li>\n\t<\/ul>\n", "interval": "1" }; var SA_Ajax = { "ajaxurl": "\/backhoe-heavy-construction-equipment-rentals-machinery-wordpress-theme\/?wsa-ajax", "najax": "1", "last_activity": "1751156376", "focus": "yes" };</script>
    ...
    <script>window.dataLayer = window.dataLayer || []; function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date()); gtag('config', 'UA-62552021-1');</script>
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-62552021-1"></script>
    <script>window.dataLayer = window.dataLayer || []; function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date()); gtag('config', 'UA-62552021-1');</script> <noscript>
        <style>
    ...
    <section class="wpb-content-wrapper">
            ...
            <div class="wpb_column vc_column_container vc_col-sm-12">
                <div class="vc_column-inner">
                    <div class="wpb_wrapper">
                        <div class="wd_empty_space" data-heighttablet="150" data-heightdesktop="230" style="height:230px"></div>
                        <div class="wd-heading text-center" style="max-width:100%">
                            <h2 class="title_b" style="margin:0;font-size:60px;color:#fff;" data-text="Find your construction machines and more!">
                                Rent or Buy.
                            </h2>
                        ...
                        <div class="wd_empty_space" data-heightmobile="30" data-heightdesktop="40" style="height:40px"></div>
                        ...
                        <div class="brands_form one_line devia-anim item-target" data-devia-animate='{"triggerHandler":"inview","animationTarget":".item-target","duration":"1200","delay":"150","initValues":{"y":41,"z":-118,"rotateX":-65,"opacity":0},"animations":{"y":0,"z":0,"rotateX":0,"opacity":1,"delay":2,"ease":"easeOutQuint"}}'>
                            <div class="html-before item-target"></div>
                            <form role="search" method="get" action="#">
                                <ul class="inline-list">
                                    <li class="item-target">
                                        <input type="hidden" name="post_type" value="product">
                                        <select name="s" id="product_name">
                                            <option value=""></option>
                                        </select>
                                    </li>
                                    <li class="item-target">
                                        <select name="product-category" id="term" class="product_categories">
                                            ...
                                            @foreach($categories as $category)
                                                ...
                                                @foreach($category->categoryType as $type)
                                                    ...
                                                    @endphp
                                                    <option class="level-1" value="{{ $type->slug }}">
                                                        &nbsp;&nbsp;{{ $type->name }}  ({{ $typeCount }})
                                                    </option>
                                                @endforeach
                                            @endforeach
                        ...
                        <div class="wd_empty_space" data-heightmobile="30" data-heighttablet="130px" data-heightdesktop="200" style="height:200px;"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="vc_row wpb_row vc_row-fluid">
            <div class="wpb_column vc_column_container vc_col-sm-12">
                <div class="vc_column-inner">
                    <div class="wpb_wrapper">
                        <div class="wd_empty_space" data-heightmobile="50" data-heighttablet="50" data-heightdesktop="100" style="height:100px"></div>
                        <div class="wd-heading text-left" style="max-width:100%">
                            <h2 class="title_a" style="margin:0;font-weight:800;" data-text="Let's Choose">Categories</h2>
                            <p class="sub_title_a">Let's Choose</p>
                            <hr class="hr_a" style="margin:10px;" />
                        </div>
                        <div class="wd_empty_space" data-heightmobile="20" data-heighttablet="20" data-heightdesktop="60" style="height:60px"></div>
                        <div class="woocommerce columns-4">
                            <ul class="products columns-4 grid">
                                @foreach($categories as $category)
                                    @php
                                        // Try to get the first machine with an image from direct machines
                                        $machine = $category->machines->whereNotNull('image')->first();
                                        // If not found, try from categoryType machines
                                        if (!$machine) {
                                            foreach ($category->categoryType as $type) {
                                                $machine = $type->machines->whereNotNull('image')->first();
                                                if ($machine) break;
                                            }
                                        }
                                        ...
                                        $imgUrl = $machine && $machine->img_url
                                        ...
                                        $typeMachines = $category->categoryType->sum(fn($type) => $type->machines->count());
                                        $totalCount = $directMachines + $typeMachines;
                                    @endphp
                                    <li class="product-category product">
                                        <a aria-label="Visit product category {{ $category->name }}" href="#">
                                            <img src="{{ $imgUrl }}" alt="{{ $category->name }}" width="700" height="518" style="object-fit:cover;" />
                                            <h2 class="woocommerce-loop-category__title">
                                                {{ $category->name }} <mark class="count">({{ $totalCount }})</mark>
                                            </h2>
                                        </a>
                                    </li>
                                @endforeach
                        ...
                        <div class="wd_empty_space" data-heightmobile="10" data-heighttablet="25" data-heightdesktop="25" style="height:25px;"></div>
                        <div class="wd_empty_space" data-heightmobile="100" data-heighttablet="200" data-heightdesktop="200" style="height:200px;"></div>
                    </div>
                </div>
            </div>
        </div>
...
@section('script')
    ...
    <script async data-noptimize="1"
        src='front_end/wp-content/plugins/autoptimize/classes/external/js/lazysizes.min.js'></script>
    <script
        type='text/javascript'>(function () { var c = document.body.className; c = c.replace(/woocommerce-no-js/, 'woocommerce-js'); document.body.className = c; })();</script>
    ...
    <script defer
        src="front_end/wp-content/cache/autoptimize/1/js/autoptimize_6634aecf610e4645998c1e77c1060f84.js"></script>
