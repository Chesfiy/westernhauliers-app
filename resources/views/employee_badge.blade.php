...
@section('style')
    ...
    <head>
        ...
        <title>{{$employee->name}} Bage.</title>
    ...
    <section class="titlebar">
            <div class="row">
                <div class="large-12 columns">
                    <h1 class="mt-20" style="color:#ccc">Bage for Employee <strong>{{ $employee->name}} </srong> will be here soon.</h1>
                </div>
            </div>
        </section>
