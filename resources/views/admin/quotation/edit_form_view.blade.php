...
@section('form_view')
    ...
    <div class="card card-warning card-outline mb-4">
        <!--begin::Form-->
        <form action="{{ route('admin.updateQuotation', $quotation->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!--begin::Body-->
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-sm-9 position-relative">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <input type="text" value="{{ isset($quotation) ? $quotation->name : '' }}" name="name"
                ...
                <div class="row mb-3">
                    <div class="col-sm-6">
                                ...
                                <select name="category_id"
                                    ...
                                    @foreach (App\Models\Category::all() as $category)
                                        <option value="{{ $category->id }}"
                                            {{ isset($quotation->category) && $quotation->category->id == $category->id ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="category_type_id"
                                    ...
                                    @foreach (App\Models\CategoryType::all() as $type)
                                        <option required value="{{ $type->id }}"
                                            {{ isset($quotation->type) && $quotation->category_type_id == $type->id ? 'selected' : '' }}>
                                            {{ $type->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="model_id" class="form-control border-0 border-bottom rounded-0 shadow-none">
                                    ...
                                    @foreach (App\Models\MachineModel::all() as $model)
                                        <option required value="{{ $model->id }}"
                                            {{ isset($quotation->model) && $quotation->model->id == $model->id ? 'selected' : '' }}>
                                            {{ $model->number }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea name="description" class="form-control border-0 border-bottom rounded-0 shadow-none" rows="3">{{ old('description', isset($machine) ? $quotation->description : '') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                                ...
                                <select name="fuel_id" class="form-control border-0 border-bottom rounded-0 shadow-none">
                                    ...
                                    @foreach (App\Models\Fuel::all() as $fuel)
                                        <option required value="{{ $fuel->id }}"
                                            {{ isset($quotation->$fuel) && $quotation->fuel_id == $fuel->id ? 'selected' : '' }}>
                                            {{ $fuel->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select name="brand_id" class="form-control border-0 border-bottom rounded-0 shadow-none">
                                    ...
                                    @foreach (App\Models\Brand::all() as $brand)
                                        <option required value="{{ $brand->id }}"
                                            {{ isset($quotation->brand) && $quotation->brand->id == $brand->id ? 'selected' : '' }}>
                                            {{ $brand->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3 form-check">
                            ...
                            <input type="checkbox" name="is_for_sale" id="isSale" value="1"
                                {{ old('is_for_sale', $quotation->is_for_sale ?? false) ? 'checked' : '' }} />
                        </div>
                        ...
                        <div class="mb-3 form-check">
                            ...
                            <input type="checkbox" name="is_for_rent" id="isRent" value="1"
                                {{ old('is_for_rent', $quotation->is_for_rent ?? false) ? 'checked' : '' }} />
                        </div>
                    </div>
                </div>
                <div class="row mb-3">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="other-tab" data-bs-toggle="tab" data-bs-target="#other"
                                type="button" role="tab" aria-controls="other" aria-selected="false">Machine</button>
                        </li>
                            ...
                            <div class="row mt-3">
                                <div class="col-sm-6">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="current_location"
                                                value="{{ old('current_location', isset($machine) ? $quotation->current_location : '') }}"
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" step="0.01" name="sale_price"
                                                value="{{ old('sale_price', isset($machine) ? $quotation->sale_price : '') }}"
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="SKU"
                                                value="{{ old('SKU', isset($machine) ? $quotation->SKU : '') }}"
                                                placeholder="SKU"
                                                class="form-control border-0 border-bottom rounded-0 shadow-none"
                                                id="inputSKU" />
                                        </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="col-sm-10">
                                                {{-- <textarea name="notes" class="form-control" id="inputNotes">{{ old('notes', isset($machine) ? $quotation->notes : '') }}</textarea> --}}
                                                <div id="inputNotes" class="form-control">
                                                    {!! old('notes', isset($machine) ? $quotation->notes : '') !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" step="0.01" name="rental_price_per_hour"
                                                value="{{ old('rental_price_per_hour', isset($machine) ? $quotation->rental_price_per_hour : '') }}"
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" step="0.01" name="rental_price_per_day"
                                                value="{{ old('rental_price_per_day', isset($machine) ? $quotation->rental_price_per_day : '') }}"
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" step="0.01" name="rental_price_per_week"
                                                value="{{ old('rental_price_per_week', isset($machine) ? $quotation->rental_price_per_week : '') }}"
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" step="0.01" name="rental_price_per_month"
                                                value="{{ old('rental_price_per_month', isset($machine) ? $quotation->rental_price_per_month : '') }}"
