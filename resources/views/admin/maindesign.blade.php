...
<head>
    ...
    <title>Westernhauliers Admin</title>
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
        <!--begin::Header-->
        <nav class="app-header navbar navbar-expand bg-body z-50">
            <!--begin::Container-->
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-footer">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <x-dropdown-link :href="route('logout')" class="btn btn-default btn-flat float-end"
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="admin/index.html" class="brand-link">
                    ...
                    <!--end::Brand Image-->
                    <!--begin::Brand Text-->
                    <span class="brand-text fw-light">WH</span>
                    <!--end::Brand Text-->
                </a>
                <!--end::Brand Link-->
            </div>
