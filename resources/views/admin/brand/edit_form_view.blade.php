...
@section("form_view")
    ...
    <div class="card card-warning card-outline mb-4">
        <!--begin::Form-->
        <form action="{{ route('admin.editBrand') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!--begin::Body-->
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-sm-9 position-relative">
                        ...
                        <div class="row position-absolute top-0 right-10 w-100">
                            <div class="col-sm-12">
                                <input type="text" name="name" placeholder="Machine Name" value="{{ old('name', isset($brand) ? $brand->name : '') }}"
