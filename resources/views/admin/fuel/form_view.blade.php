...
@section("form_view")
    ...
    <div class="card card-warning card-outline mb-4">
        <form action="{{ isset($fuel) ? route('admin.updateFuel', $fuel->id) : route('admin.storeFuel') }}" method="POST">
            @csrf
            <!--begin::Body-->
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-sm-9">
                        ...
                        <div class="row w-100">
                            <div class="col-sm-12">
                                <input type="text" name="name" placeholder="Power / Fuel: eg Diesel" value="{{isset($fuel) ? $fuel->name : ''}}"
