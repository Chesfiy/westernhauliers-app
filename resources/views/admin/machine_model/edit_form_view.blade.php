                ...
                <div class="row mb-3">
                    <div class="col-sm-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="width" placeholder="eg: 2.5m"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="height" placeholder="eg: 3.0m"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="raised_height" placeholder="eg: 3.0m"
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="capacity" placeholder="eg: 3000kg"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="lift_working" placeholder="eg: SM037030"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="wheel_base" placeholder="eg: 2.5m"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="unit" placeholder="eg: m"
