...
@section('style')
    ...
    <head>
        ...
        <title>About us - Western Hauliers &amp; Construction Equipment Rentals</title>
        ...
        <meta property="og:title" content="About us - Western Hauliers &amp; Construction Equipment Rentals" />
        <meta property="og:url" content="{{ url('/') }}" />
        <meta property="og:site_name" content="Western Hauliers &amp; Construction Equipment Rentals" />
        ...
        <style id='global-styles-inline-css' type='text/css'>
            :root {
                ...
                --wp--preset--color--luminous-vivid-orange: rgba(227, 6, 19, 1);
                --wp--preset--color--luminous-vivid-amber: #E30613;
                ...
                --wp--preset--gradient--luminous-vivid-amber-to-luminous-vivid-orange: linear-gradient(135deg, rgba(227, 6, 19, 1) 0%, rgba(227, 6, 19, 1) 100%);
                --wp--preset--gradient--luminous-vivid-orange-to-vivid-red: linear-gradient(135deg, rgba(227, 6, 19, 1) 0%, #cf2e2e 100%);
                --wp--preset--gradient--very-light-gray-to-cyan-bluish-gray: linear-gradient(135deg, #eee 0%, #a9b8c3 100%);
                --wp--preset--gradient--cool-to-warm-spectrum: linear-gradient(135deg, #4aeadc 0%, #9778d1 20%, #cf2aba 40%, #ee2c82 60%, #fb6962 80%, #ff4753ff 100%);
                --wp--preset--gradient--blush-light-purple: linear-gradient(135deg, #ffceec 0%, #9896f0 100%);
                --wp--preset--gradient--blush-bordeaux: linear-gradient(135deg, #ffa7adff 0%, #fe2d2d 50%, #6b003e 100%);
                --wp--preset--gradient--luminous-dusk: linear-gradient(135deg, #ffa7adff 0%, #c751c0 50%, #4158d0 100%);
        ...
        <style id='backhoe-style-inline-css' type='text/css'>
            :root {
                ...
                --title-page-background: url("front_end/wp-content/themes/backhoe/images/pattern-brick.png");
                ...
                --footer-background-image: url("{{ asset('front_end/wp-content/themes/backhoe/images/pattern_dashed.html') }}");
            ...
            .titlebar {
                background-image: url({{ asset('front_end/wp-content/uploads/2019/09/titlebar-bg.jpg') }})
            }
                        ...
                        <section class="wpb-content-wrapper">
                                        ...
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd-heading text-left  " style="max-width: 100%">
                                                <h2 style="margin:0;" class="title_b"
                                                    data-text="Western Hauliers was established to address the growing demand for professionally managed, safety-compliant lifting and material handling services within Tanzania’s expanding industrial and infrastructure sectors.">
                                                    We are Energetic Company</h2>Western Hauliers was established to address
                                                the growing demand for
                                                professionally managed, safety-compliant lifting and material
                                                handling services within Tanzania's expanding industrial and infrastructure
                                                sectors.</p>
                                                <p>Recognizing a market gap in certified equipment and disciplined
                                                    execution, the company
                                                    invested strategically in modern machinery, skilled operators, and
                                                    structured safety systems.</p>
                                            </div>
                                                ...
                                                <div class="wpb_wrapper">
                                                    <div class="wd-video-box"
                                                        ...
                                                        <div class="full_screen_video_wrapper  text-left"><a
                                                            ...
                                                            <div class="medium reveal" id="modal68a73a82d04c3" data-reveal
                                            ...
                                            <div class=" text-icon text-icon--icon-top_position boxes  clearfix">
                                                <div class="text-icon__container  left ">
                                                    ...
                                                    <div class="text-icon__content-box">
                                                        <h4 class="text-icon__title "> Our Vision</h4>
                                                        <p class="text-icon__text  "> To be the most trusted and
                                                            technically advanced
                                                            provider of material handling, heavy lifting, and specialized
                                                            transportation
                                                            solutions in Tanzania and the wider East African region,
                                                            setting industry benchmarks for safety, reliability, and
                                            ...
                                            <div class=" text-icon text-icon--icon-top_position boxes  clearfix">
                                                <div class="text-icon__container  left ">
                                                    <div class="text-icon__icon-box "> <noscript><img decoding="async"
                                                            ...
                                                            alt='icon' /></div>
                                                    <div class="text-icon__content-box">
                                                        <h4 class="text-icon__title "> Our Mission</h4>
                                                        <p class="text-icon__text  "> To deliver safe, efficient, and
                                                            engineered lifting and
                                                            transportation solutions through certified equipment, skilled
                                                            professionals, and
                                                            disciplined planning—ensuring project success,
                                                            operational continuity, and long-term partnerships with our
                                                            clients.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class=" text-icon text-icon--icon-top_position boxes  clearfix">
                                                <div class="text-icon__container  left ">
                                                    <div class="text-icon__icon-box "> <noscript><img decoding="async"
                                                            ...
                                                            alt='icon' /></div>
                                                    <div class="text-icon__content-box">
                                                        <h4 class="text-icon__title "> Our Values</h4>
                                                        <p class="text-icon__text  ">
                                                        <ul>
                                                            <li>Safety First: Zero harm is our only acceptable standard. We
                                                                prioritize the well-being of our team, clients, and the
                                                                public in every operation.</li>
                                                            <li>Integrity </li>
                                                            <li>Reliability </li>
                                                        </ul>
                                                        </p>
                                    ...
                                    <div class="vc_column-inner vc_custom_1562413453755">
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd-heading text-left  " style="max-width: 100%">
                                                ...
                                                <p style="color:#000000;" class="sub_title_b"> Years of Undefeated Success
                                                    represent
                                                    a proven history of completed projects, satisfied clients, and
                                                    operational excellence.
                                                    Western Hauliers continues to set benchmarks
                                                    in heavy lifting and material handling through reliability, technical
                                                    expertise, and consistent delivery</p>
                                            </div>
                                ...
                                <div class="wpb_column vc_column_container vc_col-sm-3">
                                    <div class="vc_column-inner">
                                        <div class="wpb_wrapper">
                                            <div class="wd_empty_space" data-heightmobile="0" data-heighttablet="30"
                                                data-heightdesktop="40" style="height: 40px;"></div>
                                            <div class=" no-hover text-icon text-icon--icon-left_position boxes  clearfix">
                                    ...
                                    <div class="vc_column-inner vc_custom_1562415105054">
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd-heading text-left  " style="max-width: 495px">
                                                ...
                                                <p style="color:#ffffff;" class="sub_title_c"> Safety is the foundation of
                                                    everything we do.
                                                    Every operation is planned, assessed, and
                                                    executed with uncompromising commitment to protecting people, assets,
                                                    and the environment.</p>
                                            </div>
                                            <div class='wd_empty_space' data-heightmobile='' data-heighttablet=''
                                                data-heightdesktop='' style='height:px'></div>
                                            <div class="wd_empty_space" data-heightmobile="50" data-heighttablet="50"
                                                data-heightdesktop="106" style="height: 106px;"></div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="text-icon__container   ">
                                                    <div class="text-icon__icon-box "> <svg
                                                            ...
                                                            <g id="Group_906" data-name="Group 906"
                                                                ...
                                                                <path id="polygon257" d="M8286,3167.086h20.912V3152H8286Z"
                                                                    transform="translate(-6928.041 -2554.358)"
                                                                    fill="#fff" />
                                                                <path id="polygon259" d="M8613,3503.516h5.423V3502H8613Z"
                                                                    transform="translate(-7247.296 -2896.07)"
                                                                    fill="#1d1d1d" />
                                                                <path id="polygon261" d="M8498,3376.492h10.87V3375H8498Z"
                                                                    transform="translate(-7135.02 -2772.077)"
                                                                    fill="#1d1d1d" />
                                                                <path id="polygon263" d="M8254,2768.885h1.516V2734H8254Z"
                                                                ...
                                                                <path id="path273"
                                                                    ...
                                                                    fill="#1d1d1d" />
                                                                <path id="polygon275" d="M7913,2826.516h2.913V2825H7913Z"
                                                                    transform="translate(-6563.874 -2235.103)"
                                                                    fill="#1d1d1d" />
                                                                <path id="polygon277" d="M7913,2948.516h2.913V2947H7913Z"
                                                                    transform="translate(-6563.874 -2354.214)"
                                                                    fill="#1d1d1d" />
                                                                <path id="polygon279" d="M7913,3071.516h2.913V3070H7913Z"
                                                                    transform="translate(-6563.874 -2474.301)"
                                                                    fill="#1d1d1d" />
                                                                <path id="polygon281" d="M7913,3194.516h2.913V3193H7913Z"
                                                                    transform="translate(-6563.874 -2594.388)"
                                                                    fill="#1d1d1d" />
                                                                <path id="polygon283" d="M7913,3317.492h2.913V3316H7913Z"
                                                                    transform="translate(-6563.874 -2714.475)"
                                                                    fill="#1d1d1d" />
                                                                <path id="polygon285" d="M7913,3440.492h2.913V3439H7913Z"
                                                                    transform="translate(-6563.874 -2834.562)"
                                                                    fill="#1d1d1d" />
                                                                <path id="polygon287" d="M7913,3562.516h2.913V3561H7913Z"
                                                                    transform="translate(-6563.874 -2953.672)"
                                                                    fill="#1d1d1d" />
                                                                <path id="polygon289" d="M7913,3685.516h2.913V3684H7913Z"
                                                                    transform="translate(-6563.874 -3073.759)"
                                                                    fill="#1d1d1d" />
                                                                <path id="polygon291" d="M7913,3808.492h2.913V3807H7913Z"
                                                                    transform="translate(-6563.874 -3193.846)"
                                                                    fill="#1d1d1d" />
                                                                <path id="polygon293" d="M7913,3930.516h2.913V3929H7913Z"
                                                                    transform="translate(-6563.874 -3312.957)"
                                                                    fill="#1d1d1d" />
                                                                <path id="polygon295" d="M7913,4053.516h2.913V4052H7913Z"
                            ...
                            <div data-vc-full-width="true" data-vc-full-width-init="false"
                                ...
                                <div class="wpb_column vc_column_container vc_col-sm-12">
                                    <div class="vc_column-inner">
                                        <div class="wpb_wrapper">
                                            <div class="wd_empty_space" data-heightmobile="90" data-heighttablet="90"
                                                data-heightdesktop="90" style="height: 90px;"></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="vc_column-inner">
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd-heading text-left  " style="max-width: 100%">
                                                ...
                                                <hr class='hr_a'
                                                    style=' margin: 10px;width: 72px;border-bottom-color: #E30613;' />
                                            </div>
                                            ...
                                            <div class='small-up-1 medium-up-2 large-up-1'>
                                                ...
                                                <div class="column column-block ">
                                                    <article
                                                        ...
                                                        <div class="wd-post__content">
                                                            <h3 class="wd-post__title"> <a href="#">Ports &
                                                                    Logistics</a></h3>
                                                        </div>
                                                    </article>
                                                </div>
                                                <div class="column column-block ">
                                                    <article
                                                        class="wd-post wd-post--without-thumbnail  post-262 post type-post status-publish format-standard has-post-thumbnail hentry category-news">
                                                        <div class="wd-post__content">
                                                            <h3 class="wd-post__title"> <a href="#">Energy &
                                                                    Power</a></h3>
                                                        </div>
                                                    </article>
                                                </div>
                                                <div class="column column-block ">
                                                    <article
                                                        class="wd-post wd-post--without-thumbnail  post-262 post type-post status-publish format-standard has-post-thumbnail hentry category-news">
                                                        <div class="wd-post__content">
                                                            <h3 class="wd-post__title"> <a href="#">Manufacturing &
                                                                    Industrial Plants</a></h3>
                                                        </div>
                                                    </article>
                                                </div>
                                                <div class="column column-block ">
                                                    <article
                                                        class="wd-post wd-post--without-thumbnail  post-262 post type-post status-publish format-standard has-post-thumbnail hentry category-news">
                                                        <div class="wd-post__content">
                                                            <h3 class="wd-post__title"> <a href="#">Mining & Natural
                                                                    Resources</a></h3>
                                                        </div>
                                                    </article>
                                                </div>
                                ...
                                <div class="wpb_column vc_column_container vc_col-sm-3">
                                    <div class="vc_column-inner">
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd_empty_space" data-heightmobile="0" data-heighttablet="80"
                                                data-heightdesktop="100" style="height: 100px;"></div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="vc_column-inner">
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd-count-up "> <noscript><img decoding="async" width="64"
                                                ...
                                                <h4 class="wd-count-up__title small-heading" style = 'color: #ffffff'>Up
                                                    Time</h4>
                                            </div>
                                            <div class="wd_empty_space" data-heightmobile="60" data-heighttablet="80"
                                                data-heightdesktop="100" style="height: 100px;"></div>
                                    ...
                                    <div class="vc_column-inner">
                                        <div class="wpb_wrapper">
                                            ...
                                            <div class="wd-heading text-left  " style="max-width: 100%">
                                                ...
                                                <hr class='hr_a'
                                                    style=' margin: 10px;width: 73px;border-bottom-color: #E30613;border-bottom-width: 6px;' />
                                            </div>
                                            <div class='wd_empty_space' data-heightmobile='67' data-heighttablet='67'
                                                data-heightdesktop='50' style='height:50px'></div>
